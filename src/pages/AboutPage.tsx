  ...
  return (
    <>
      ...
      <PageHeader
        ...
        description="A technology-driven innovation platform bridging the gap between ideas and execution for students, researchers, startups, and businesses."
      />
      <section className="section-padding">
        <div className="container-narrow prose prose-lg dark:prose-invert max-w-none">
          <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
            ...
            startups, researchers, and businesses transform ideas into real-world solutions.
          </p>
          <p className="mt-6 text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
            ...
            resources, documentation support, research guidance, time, or mentorship. Projonexa
